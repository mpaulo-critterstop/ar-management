...
export const ALL_MODULES = ['ar', 'dispatch', 'leads', 'csr', 'field-performance', 'dialpad', 'kpi', 'pest-sales', 'lsa-leads', 'csr-pest-sales', 'cancellations', 'service-pool', 'reports'] as const;
