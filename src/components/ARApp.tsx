...
export default function ARApp() {
  ...
  return (
    <div>
      ...
      {page==="dashboard" && <DashPage {...shared} totalAR={totalAR} totalOverdue={totalOverdue} collected30={collected30} collRate={collRate} agingTotals={agingTotals} brokenPromises={brokenPromises} officeFilter={officeFilter} collectedDays={collectedDays} setCollectedDays={setCollectedDays} customDateFrom={customDateFrom} customDateTo={customDateTo} setCustomDateFrom={setCustomDateFrom} setCustomDateTo={setCustomDateTo} />}
